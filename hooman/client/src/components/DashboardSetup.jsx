  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        ...
        const filledFields = Object.values(res.data.data).filter(
  ...
  return (
    <div className={`${theme.colors.background} min-h-screen flex items-start justify-start`}>
      <div className="w-full max-w-md p-8">
        ...
        <Progress
          value={progress}
          className="w-full h-1 bg-gray-300 rounded-full mb-6"
          indicatorClassName="bg-orange-500 rounded-full"
        />
        ...
        <p className="text-gray-600 mb-6">It's almost ready</p>
        ...
        <div className="relative w-32 h-32 mx-auto mb-6">
          <svg className="w-full h-full" viewBox="0 0 100 100">
            ...
            <circle
              ...
              r="45"
              fill="none"
              stroke="#f97316" // Matches bg-[#E95744]
              strokeWidth="10"
